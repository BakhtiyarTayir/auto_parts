...
final class Elementor_Master {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-master' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_MASTER ) );
...
// Instantiate Elementor_Master.
new Elementor_Master();
