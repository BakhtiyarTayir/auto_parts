...
class Contact_Header extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact header', 'elementor' );
	}
...
<div class="head_img head_img_minh">
	<div class="head_img_aligner -align-left">
		<picture class="head-img-overlay"><img
				src="<?php echo $settings['background-image']['url']; ?>">
		</picture>
	</div>
</div>
